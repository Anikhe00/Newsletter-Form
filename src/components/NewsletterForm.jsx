...
export default function NewsletterForm({
  ...
  return (
    <section className="flex w-full md:w-[38rem] lg:w-[56.5rem] md:h-[54.875rem] lg:h-[40.063rem] md:p-[2rem] h-dvh md:rounded-[2.25rem] md:bg-white md:shadow-[0_15px_60px_0_rgba(0,0,0,0.25)]">
      <div className="flex flex-col lg:flex-row-reverse w-full items-center lg:items-center lg:justify-center gap-[2.5rem] ">
        ...
        />
        <div className="flex flex-col items-start gap-[2.5em] md:gap-[1.5rem] lg:gap-[2rem] md:self-stretch lg:h-full lg:justify-center px-[1.5rem] lg:px-0 md:px-0">
